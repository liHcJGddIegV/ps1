...
foreach ($user in $users) {
    ...
    $subject = "Your GE Domain Account for the Diversion Wind Project"

    # Revised email body
    $body = @"
Dear $firstName,

We are excited to inform you that your GE domain account for the Diversion Wind Project has been successfully created. Please find your login credentials below:

Username: [$($user.Username)]
Domain: [TXDIVERSIO\$($user.Username)]
...
Use the AEP jumphost from the ICC workstation at 204.29.193.5 to access the GE system.
...
Thank you, and welcome to the Diversion Wind Project!
